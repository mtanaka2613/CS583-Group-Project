...
public class ThirdPersonController: MonoBehaviour
{
   ...
   //Player Collides with another Collider
    ...
    {
        Vector3 temp = new Vector3 (childColliders[1].size.x, childColliders[1].size.y, childColliders[1].size.z);
        childColliders[1].size = temp * 2;
        yield return new WaitForSecondsRealtime(10f);
        childColliders[1].size = temp;
